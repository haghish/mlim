...
.onAttach <- function(lib, pkg) {
  packageStartupMessage('Multiple Imputation algorithm is under modification and is known to inflate the correlations between the variables. the solution is currently under testing...\n')
